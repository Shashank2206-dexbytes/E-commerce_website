...
<body>
    ...
    <div class="login-container">
        <form class="login-form" method="POST" id="validation">
            <img src="images/user/form-user.png" alt="logo" id="adminlogo" height="100px" width="100px">
...
<!-- $joinsql="SELECT c1.category_name
            FROM category c1
            JOIN category c2 ON c1.category_id = c2.parent_category
            "; -->
