...
$joinsql="SELECT  p.category_name AS parent FROM category c INNER JOIN category p ON c.parent_category = p.category_id;";
                                ...
                                <div class="basic-form">
                                    ...
                                    <form action="" method="POST" >
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <?php
                                                    ...
                                                    {?>
                                                    <option value=<?php echo $showupData['category_name']?>><?php echo $data['parent'] ?></option>;
                                                    <?php } ?> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control h-150px" rows="6" id="comment"  name="category_description" value=<?php echo $showupData['category_description'] ?>></textarea>
                                        </div>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <img src="images/member/<?php echo $showupData['category_image'] ?>" value=<?php echo $showupData['category_image'] ?> alt="member" id="bulk" height="50px" width="50px">
                                            </div>
                                        ...
                                        <?php if(isset($_GET['category_id'])) ?><?php{?>
